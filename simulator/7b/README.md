...
UI LVGL 1024 × 600 theo ảnh `example_UI`, font Antonio trong `ui/7b/fonts`. Xem [tài liệu duyệt UI](../../docs/UI_7B_REVIEW.md).
...
Không giả lập CPU ESP32-S3; không kết nối serial, CAN, BLE hoặc Lisp runtime. Chưa ghép UI vào firmware. Build dùng CMake/Ninja và MinGW32 trên máy; LVGL/Win32 trong repo, font trong `ui/7b/fonts`.
